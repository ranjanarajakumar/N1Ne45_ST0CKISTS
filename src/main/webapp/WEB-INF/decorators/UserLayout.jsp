       ...
       <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="#">Work Panel</a>
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            <li class="active">
                                <a href="<c:url value="/home"/>">Main Page</a>
                            </li>
                            <li class="dropdown">
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li class="active">
                            <a href="<c:url value="/home"/>"><i class="icon-chevron-right"></i> Main Page</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<c:url value="/admin/home"/>"><i class="icon-chevron-right"></i> Admin</a>
                        </li>
                        <!-- 
                        <li>
